...
SELECT 
	id,
    salary,
    CONCAT(firstname," ", lastname) AS fullname -- функция для склеивания значений в один столбец: имя и фамилию / / "Вася" + " " + "Петров"  = "Вася Петров"
FROM staff
...
SELECT 
    ...
    ROUND(SUM(salary))AS sum_s, -- до целого числа
